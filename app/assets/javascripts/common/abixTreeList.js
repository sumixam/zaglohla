...
;(function($, window, document, undefined) {
    ...
    Plugin.prototype.init = function() {
        ...
        $('.js-expanded > span.icon').trigger('click');
    };

    Plugin.prototype.expand = function($branch) {
        var self = this;
        $branch.children('ul,ol').children('li').show(1, function() {
    ...
    Plugin.prototype.collapse = function($branch) {
        var self = this;
        $branch.children('ul,ol').children('li').hide(1, function() {
    ...
    Plugin.prototype.collapseAll = function() {
        var self = this;
        self.$allBranches.not(self.$topLevelBranches).hide(1, function() {
