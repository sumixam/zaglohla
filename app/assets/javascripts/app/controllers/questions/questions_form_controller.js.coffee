class App.QuestionsFormController extends App.BaseController
  ...
  events:
    ...
    'click .js-submit-question' : 'submitForm'
    'click .js-rm-photo': 'rmPhoto'

  constructor: ->
    super
    do @initSelect2
    @formShouldBeSubmited = false
  ...
  plusPhoto: (e) ->
    e.preventDefault()
    $('.js-plus-photo').parent().prepend '<div><input class="js-question-photo-input st-unitLeft d2-push-top" name="question[photos_attributes][][pic]" type="file" value="1" data-buttonText="Заменить файл"><div class="st-unitLeft d2-push-top d2-push-left rm-photo js-rm-photo">x</div><div class="clear"/></div>'
    $(".js-question-photo-input:last").trigger("click")
