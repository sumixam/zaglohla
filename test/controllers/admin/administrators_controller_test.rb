...
class Admin::AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create admin_administrator" do
    assert_difference('Admin::Administrator.count') do
      post :create, admin_administrator: { acl: @admin_administrator.acl, email: @admin_administrator.email, password: @admin_administrator.password }
    end
  ...
  test "should update admin_administrator" do
    patch :update, id: @admin_administrator, admin_administrator: { acl: @admin_administrator.acl, email: @admin_administrator.email, password: @admin_administrator.password }
    assert_redirected_to admin_administrator_path(assigns(:admin_administrator))
  end
