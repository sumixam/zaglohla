...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { city_id: @admin_user.city_id, email: @admin_user.email, name: @admin_user.name, password: @admin_user.password, phone: @admin_user.phone, type: @admin_user.type }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { city_id: @admin_user.city_id, email: @admin_user.email, name: @admin_user.name, password: @admin_user.password, phone: @admin_user.phone, type: @admin_user.type }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
